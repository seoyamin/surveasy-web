    ...
    <div class="option-container">
      <div class="option-left-content" :style="{ flex: 1 }">
        ...
        <select class="option-select" v-model="this.headCount">
          ...
          <option :value="String('HEAD_200')">200명</option>
          <option :value="String('HEAD_220')">220명</option>
          <option :value="String('HEAD_240')">240명</option>
          <option :value="String('HEAD_260')">260명</option>
          <option :value="String('HEAD_280')">280명</option>
          <option :value="String('HEAD_300')">300명 (최대 응답수)</option>
        </select>
...
export default {
  data(){
    return{
      ...
      priceTable:
        [ [9900, 9900, 13200, 16500, 19800, 23100, 26400, 29700, 33000, 39600, 46200, 52800, 59400, 66000, 72600, 79200, 85800, 92400, 99000],
          [9900, 9900, 13200, 16500, 19800, 23100, 26400, 29700, 33000, 39600, 46200, 52800, 59400, 66000, 72600, 79200, 85800, 92400, 99000],
          [29700, 29700, 39600, 49500, 59400, 69300, 79200, 89100, 99000, 118800, 138600, 158400, 178200, 198000, 217800, 237600, 257400, 277200, 297000],
          [59400, 59400, 79200, 99000, 118800, 138600, 158400, 178200, 198000, 237600, 277200, 316800, 356400, 396000, 435600, 475200, 514800, 554400, 594000],
          [99000, 99000, 132000, 165000, 198000, 231000, 264000, 297000, 330000, 396000, 462000, 528000, 594000, 660000, 726000, 792000, 858000, 924000, 990000],
          [148500, 148500, 198000, 247500, 297000, 346500, 396000, 445500, 495000, 594000, 693000, 792000, 891000, 990000, 1089000, 1188000, 1287000, 1386000, 1485000],
          [198000, 198000, 264000, 330000, 396000, 462000, 528000, 594000, 660000, 792000, 924000, 1056000, 1188000, 1320000, 1452000, 1584000, 1716000, 1848000, 1980000] 
      ],
